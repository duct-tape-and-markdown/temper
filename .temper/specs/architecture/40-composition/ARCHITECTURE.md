+++
[satisfies.assembly]
rationale = "40-composition owns `assembly` — the layered binding declaration authored as the SDK's config module, its locusless facts emitted as temper-owned artifacts — and the authoring loop that produces it; the only home for `assembly`"

[provenance]
source_path = "./specs/architecture/40-composition.md"
source_hash = "e42a8ea2cebbd756eeee18ad85cb673aa899ce90f5a27bcc0b32f182deba6d3c"
+++
