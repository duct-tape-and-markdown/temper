...
rationale = "20-surface owns the SDK — the typed module library, its emit contract (refusals, byte-determinism), and the adoption states around it"

[satisfies.manifest]
rationale = "20-surface owns the compiler interchange (the member schema, in-memory) and the lock — the committed freshness anchor — plus the emit determinism that binds source to output"

[provenance]
source_path = "./specs/architecture/20-surface.md"
source_hash = "fc971dbcceaafc01082bbb62e6e8d242164efa36edc67726eb570682f6374c46"
+++
