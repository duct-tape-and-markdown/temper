...
- **An entry is scoped to one comfortable context.** Build should land
  ...
  splits the next derivation smaller; consistently tiny ticks license
  wider slices. Sizing judgment happens once, at derivation — build
  never re-scopes at pick time.
