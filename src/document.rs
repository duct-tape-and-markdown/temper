...
//! co-authorship constraint the TOML-dialect Decision rests on
...
impl Document {
    ...
    /// The parsed header, read-only. The clause tables live here as TOML tables a kind reads its typed view out of.
...
/// written parser produces. A JSON-null-unrepresentable item
...
Last line, no newline.";
    ...
    fn item_to_json_converts_each_clause_value_kind_faithfully() {
        ...
        // frontmatter matches a built-in's hand-parsed shape.
        let raw = "+++\n\
[clause.name]\nvalue = \"demo\"\n\
[clause.priority]\nvalue = 7\n\
[clause.enabled]\nvalue = true\n\
