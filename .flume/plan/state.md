...
- Posture swept through: mid-rotation, at src/contract.rs — clean; `src/coverage.rs`
  next in the c9d11d5 re-arm rotation's frontier.
- This tick: POSTURE SWEEP src/contract.rs — clean; see commit body.
...
Plan continues: yes — the posture rotation is open (coverage.rs onward
