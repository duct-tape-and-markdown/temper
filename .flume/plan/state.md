...
- Posture swept through: sdk/src/ tree fully covered; src/address.rs, src/admissibility.rs,
  ...
  src/compose.rs, src/contract.rs covered. src/coverage.rs next in tree order — mid-rotation.
- This tick: POSTURE SWEEP src/contract.rs — clean; the file's one known stale cite
  (`SHAPE_PATTERNS`, already tracked in open-questions.md) re-verified unchanged since
  8415088 and re-stamped; see commit body.
...
open posture rotation drives itself next tick, resuming at src/coverage.rs.
