...
- Posture swept through: sdk/src/ tree fully covered; src/address.rs, src/admissibility.rs,
  ...
  src/compose.rs, src/contract.rs, src/coverage.rs covered. src/coverage_note.rs next in
...
open posture rotation drives itself next tick, resuming at src/coverage_note.rs.
