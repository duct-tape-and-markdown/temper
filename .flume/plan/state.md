...
- Posture swept through: mid-rotation, at src/json_manifest.rs — advanced
  from src/install.rs; src/json_splice.rs next in the c9d11d5 rotation's
  frontier.
- This tick: POSTURE SWEEP, src/json_manifest.rs + immediate imports —
  clean, no entry filed (full DATUM in the commit body).
