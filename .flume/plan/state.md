...
- Posture swept through: sdk/src/ tree fully covered; src/address.rs, src/admissibility.rs,
  src/builtin.rs, src/builtin_kind.rs, src/builtin_lock.rs covered. src/bundle.rs next in
  tree order — mid-rotation.
- This tick: POSTURE SWEEP src/builtin_lock.rs — clean, no residue filed.
...
open posture rotation drives itself next tick, resuming at src/bundle.rs.
