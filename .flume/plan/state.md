...
- Posture swept through: sdk/src/ tree fully covered; src/address.rs, src/admissibility.rs,
  src/builtin.rs, src/builtin_kind.rs, src/builtin_lock.rs, src/bundle.rs, src/check.rs covered.
  src/compose.rs next in tree order — mid-rotation.
- This tick: POSTURE SWEEP src/check.rs — clean; see commit body.
...
open posture rotation drives itself next tick, resuming at src/compose.rs.
